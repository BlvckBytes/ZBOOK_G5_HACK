 ...
 *
 * Disassembly of SSDT-10-PegSsdt.aml, Sat Jul 11 17:08:21 2020
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x0000267D (9853)
 *     Revision         0x02
 *     Checksum         0xA2
 *     OEM ID           "PegSsd"
...
DefinitionBlock ("", "SSDT", 2, "PegSsd", "PegSsdt", 0x00001000)
{
    ...
    External (_SB_.PCI0.HDFE, MethodObj)    // 1 Arguments (from opcode)
    External (_SB_.PCI0.HDOE, MethodObj)    // 1 Arguments (from opcode)
    External (_SB_.PCI0.PEG0, DeviceObj)    // (from opcode)
    External (_SB_.PCI0.PEG0.PEGP, DeviceObj)    // (from opcode)
    External (_SB_.PCI0.PEG0.PEGP.SVDG, MethodObj)    // 0 Arguments (from opcode)
